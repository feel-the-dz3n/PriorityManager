...
LPWSTR GetPriorityClassIconId(DWORD dwPriorityClass)
{
	...
	{
	case IDLE_PRIORITY_CLASS: return MAKEINTRESOURCE(IDI_HOTFORE_IDLE);
	case BELOW_NORMAL_PRIORITY_CLASS: return MAKEINTRESOURCE(IDI_HOTFORE_BELOW_NORMAL);
	case NORMAL_PRIORITY_CLASS: return MAKEINTRESOURCE(IDI_HOTFORE_NORMAL);
	case ABOVE_NORMAL_PRIORITY_CLASS: return MAKEINTRESOURCE(IDI_HOTFORE_ABOVE_NORMAL);
	case HIGH_PRIORITY_CLASS: return MAKEINTRESOURCE(IDI_HOTFORE_HIGH);
	case REALTIME_PRIORITY_CLASS: return MAKEINTRESOURCE(IDI_HOTFORE_REALTIME);
	default: return MAKEINTRESOURCE(IDI_PRIORITYMANAGER);
	}
}
